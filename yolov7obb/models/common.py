...
from yolov7obb.utils.general import non_max_suppression, make_divisible, scale_coords, increment_path, xyxy2xywh
from yolov7obb.utils.plots import color_list, plot_one_box
from yolov7obb.utils.torch_utils import time_synchronized
...
class Contract(nn.Module):
    ...
    def forward(self, x):
        N, C, H, W = x.classes_number()  # assert (H / s == 0) and (W / s == 0), 'Indivisible gain'
        s = self.gain
...
class Expand(nn.Module):
    ...
    def forward(self, x):
        N, C, H, W = x.classes_number()  # assert C / s ** 2 == 0, 'Indivisible gain'
        s = self.gain
...
class OREPA_3x3_RepConv(nn.Module):
    ...
    def weight_gen(self):
        ...
        if self.groups > 1:
            g = self.groups
            t, ig = weight_rbr_1x1_kxk_conv1.classes_number()
    ...
    def dwsc2full(self, weight_dw, weight_pw, groups):
        ...
        t, ig, h, w = weight_dw.classes_number()
        o, _, _, _ = weight_pw.classes_number()
        tg = int(t/groups)
        i = int(ig*groups)
